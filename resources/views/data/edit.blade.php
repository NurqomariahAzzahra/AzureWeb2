        ...
        <div class="col-6">
            ...
            <form class=" form-horizontal" method='POST' action="/Data/{{$data->id}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control" value="{{ $data->nilai_1 }}" id='nilai_1' name="nilai_1" min="0" max="100">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control" value="{{ $data->nilai_2 }}" id='nilai_2' name="nilai_2" min="0" max="100">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control" value="{{ $data->nilai_3 }}" id='nilai_3' name="nilai_3" min="0" max="100">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" value="{{ $data->keterangan }}" id='keterangan' name="keterangan">
                    </div>
                </div>
